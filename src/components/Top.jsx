...
export default class Top extends Component{
  ...
  scrollFn = () => {
    ...
    this.setState({show: scrollTop > 50})
  }
  ...
  render () {
    ...
    if (show) {
      ele = (
        <div 
          onClick={this.top}
          className="fixed flex items-center justify-center bottom-0 right-0 mr-10 mb-10 mr-4 border cursor-pointer h-12 w-12 bg-white rounded-full shadow-md">
